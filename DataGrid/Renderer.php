...
class Structures_DataGrid_Renderer
{
    ...
    /**
     * Return paging links as generated by the driver
     *
     * Drivers that need paging should implement this method. It is not meant
     * to be HTML specific, it can return anything that the user can use to
     * provide a paging mechanism.
     *
     * @param array $options Paging options as supported by the driver (these
     *                       usually are HTML::Pager options, but can be other
     *                       sort of options, if the driver implements paging 
     *                       without HTML::Pager)
     ...
     *
     * This is useful for drivers that need to provide a paging feature. This
     * method sets up the $_pager protected property according to the $_page,
     * $_pageLimit and $_totalRecordsNum properties.
     *
     * This method takes the global "excludeVars", "includeVars" options as
     * well as the $_requestPrefix property into account.
     *
     * It is a somewhat HTML specific method, but since Pager offers a wide
     * range of methods, chances are that the generated $_pager property
     * can be used for non-HTML rendering.
     * 
