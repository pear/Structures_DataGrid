...
// DataSource Drivers
// FIXME: these constants should be properly documented with docblocks
define('STRUCTURES_DATAGRID_ARRAY',     'Array');
define('STRUCTURES_DATAGRID_DATAOBJECT','DataObject');
define('STRUCTURES_DATAGRID_DB',        'DB');
define('STRUCTURES_DATAGRID_RSS',       'RSS');
define('STRUCTURES_DATAGRID_DBQUERY',   'DBQuery');
define('STRUCTURES_DATAGRID_DBTABLE',   'DBTable');
define('STRUCTURES_DATAGRID_MDB2',      'MDB2');

// Old style Rendering Drivers constants (deprecated)
define('DATAGRID_RENDER_TABLE',    STRUCTURES_DATAGRID_TABLE);
define('DATAGRID_RENDER_SMARTY',   STRUCTURES_DATAGRID_SMARTY);
define('DATAGRID_RENDER_XML',      STRUCTURES_DATAGRID_XML);
define('DATAGRID_RENDER_XLS',      STRUCTURES_DATAGRID_EXCEL);
define('DATAGRID_RENDER_XUL',      STRUCTURES_DATAGRID_XUL);
define('DATAGRID_RENDER_CSV',      STRUCTURES_DATAGRID_CSV);
define('DATAGRID_RENDER_CONSOLE',  STRUCTURES_DATAGRID_CONSOLE);
define('DATAGRID_RENDER_PAGER',    STRUCTURES_DATAGRID_PAGER);
define('DATAGRID_RENDER_SORTFORM', STRUCTURES_DATAGRID_SORTFORM);

define('DATAGRID_RENDER_DEFAULT',  STRUCTURES_DATAGRID_TABLE);

// Old Style DataSource Drivers constants (deprecated)
define('DATAGRID_SOURCE_ARRAY',     STRUCTURES_DATAGRID_ARRAY);
define('DATAGRID_SOURCE_DATAOBJECT',STRUCTURES_DATAGRID_DATAOBJECT);
define('DATAGRID_SOURCE_DB',        STRUCTURES_DATAGRID_DB);
define('DATAGRID_SOURCE_XML',       STRUCTURES_DATAGRID_XML);
define('DATAGRID_SOURCE_RSS',       STRUCTURES_DATAGRID_RSS);
define('DATAGRID_SOURCE_CSV',       STRUCTURES_DATAGRID_CSV);
define('DATAGRID_SOURCE_DBQUERY',   STRUCTURES_DATAGRID_DBQUERY);
define('DATAGRID_SOURCE_DBTABLE',   STRUCTURES_DATAGRID_DBTABLE);
define('DATAGRID_SOURCE_MDB2',      STRUCTURES_DATAGRID_MDB2);
